  ...
  builder.frame(nil, "deep_frame_in_shallow_frame", true, {width = 420}){ 
    builder.frame(nil, "slot_window_frame"){ 
      builder.hflow(nil, nil, {vertical_align = "center"}){
        ...
        builder.button("create_yard", handlers.create_train_yard, "map_view_add_button", {localised_names.yard_create}, nil, nil),
      }
    },
    builder.list("rsad_overview_yardlist", get_yard_names(), state.selected_yard, nil, {vertically_stretchable = true}),
  },
...
--         builder.label({names.namespace .. "placeholder"})
--     },
...
--         gui.add(names.namespace, mod_gui.get_button_flow(state.player), builder.button(names.mod_button, "show", {"", "GUI-SUX"}), true)
-- 	end
-- }
