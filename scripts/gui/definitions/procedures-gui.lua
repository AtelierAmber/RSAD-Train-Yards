...
local procedures_tab = builder.hflow("rsad_procedures_tab", "inset_frame_container_horizontal_flow_in_tabbed_pane"){
  builder.frame(nil, "deep_frame_in_shallow_frame", true, {width = 300}){ 
    builder.frame(nil, "slot_window_frame"){ 
      builder.hflow(nil, nil, {vertical_align = "center"}){
        ...
        builder.button("create_procedure", handlers.create_train_yard, "map_view_add_button", {localised_names.routine_create}),
      }
    },
    builder.list("ssrsad_overview_yardlist", {"A", "B", "C"}, state.selected_routine, nil, {vertically_stretchable = true}),
  },
  builder.frame(nil, "invisible_frame", false){
    builder.hscroll(nil, nil, "trains_scroll_pane", {width = 1400}){
      builder.hflow("procedure_nodes", nil, {padding = 20, vertically_stretchable = true, horizontally_stretchable = true, vertical_align = "center"})
    }
  }
}
