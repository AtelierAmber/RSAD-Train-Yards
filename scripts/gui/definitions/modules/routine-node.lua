...
local routine_builder = {arrow = next_node_arrow}

function routine_builder.build_node(name, ...)
  local routine_node = builder.frame(name and (name .. "_action_node") or nil, "invisible_frame", nil, {horizontally_stretchable = false, vertically_stretchable = false, use_header_filler = false, padding = 0}){
    builder.frame(nil, "train_schedule_partially_fullfilled_condition_frame", true, {size = {260, 260}, padding = 3}){
      builder.vflow(nil, nil, {vertical_spacing = 0}){
        ...
        builder.vscroll(nil, "always", "scroll_pane_in_shallow_frame", {padding = 0}){
          builder.frame("node_content", "blueprint_parameter_frame", true, {margin = -4, horizontally_stretchable = true, vertically_stretchable = true})
            ({...}){
          },
