  ...
  builder.frame(nil, "deep_frame_in_shallow_frame", true, {width = 300}){ 
    builder.frame(nil, "slot_window_frame"){ 
      builder.hflow(nil, nil, {vertical_align = "center"}){
        ...
        builder.button("create_procedure", nil, "map_view_add_button", {localised_names.routine_create}),
      }
    },
    builder.list("rsad_procedures_list", nil, state.selected_routine, "rsad_list_box"),
  },
