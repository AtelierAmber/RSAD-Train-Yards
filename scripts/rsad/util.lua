...
function update_rsad_station_name(entity, control, index)
  ...
  entity.backer_name = "RSAD Controlled | [" ..
  network_name .. "] " .. turnabout_phase_string .. rsad_station_name[index] .. item_name
end
...
function get_back_cargo(train)
  ...
  return (back and train.carriages[#train.carriages] or train.carriages[1]),
      (back and defines.rail_direction.front or defines.rail_direction.back)
end
